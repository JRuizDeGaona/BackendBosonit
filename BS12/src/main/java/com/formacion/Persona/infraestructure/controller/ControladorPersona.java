...
public class ControladorPersona {
    ...
    /**
     * Método para buscar un profesor con RestTemplate
     * @param id ID del profesor que queremos buscar
     * @return ProfesorOutputDTO con los datos del profesor buscado
     */
    @GetMapping("/{id}")
